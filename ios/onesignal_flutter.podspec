...
Pod::Spec.new do |s|
  ...
  # s.dependency 'OneSignalXCFramework', '5.2.8' # this is an all-in-one library
  ...
  # s.dependency 'OneSignalXCFramework/OneSignalLocation', '5.2.8' # we disable location as we don't need it
